...
internal inline fun <reified T : View> AppCompatDialog.bind(@IdRes res: Int): Lazy<T?> = lazy { findView<T>(res) }
...
internal inline fun <reified T : View> AppCompatDialog.findView(@IdRes res: Int): T? = ignore { findViewById(res) }
