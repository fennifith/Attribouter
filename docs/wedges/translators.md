...
The `TranslatorsWedge` displays a list of [`TranslatorWedge`](./translator)s in sections, sorted by locale. If a translator has translated multiple locales, they will appear under every locale that they have translated.
